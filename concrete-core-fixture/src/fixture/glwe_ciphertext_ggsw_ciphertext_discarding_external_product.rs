...
use concrete_core::prelude::{
    ...
    GlweCiphertextGgswCiphertextDiscardingExternalProductEngine, GlweSecretKeyEntity,
...
where
    ...
    Engine:
        GlweCiphertextGgswCiphertextDiscardingExternalProductEngine<GlweInput, GgswInput, Output>,
        ...
        + SynthesizesPlaintextVector<Precision, PlaintextVector>,
{
    ...
    type PreExecutionContext = (GlweInput, GgswInput, Output);
    ...
    fn prepare_context(
        ...
        let proto_output = maker.trivial_encrypt_zeros_to_glwe_ciphertext(
        ...
        let synth_output = maker.synthesize_glwe_ciphertext(&proto_output);
        (synth_glwe_input, synth_ggsw_input, synth_output)
    }
    ...
    fn execute_engine(
        ...
        let (glwe_input, ggsw_input, mut output) = context;
        unsafe {
