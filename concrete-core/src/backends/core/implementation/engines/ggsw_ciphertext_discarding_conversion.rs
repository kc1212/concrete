...
impl GgswCiphertextDiscardingConversionEngine<GgswCiphertext32, GgswCiphertextComplex64>
    for CoreEngine
{
    /// # Example
    /// ```
    ...
    ///
    /// let mut fourier_ciphertext: GgswCiphertextComplex64 =
    ...
    fn discard_convert_ggsw_ciphertext(
        &mut self,
        output: &mut GgswCiphertextComplex64,
    ...
    unsafe fn discard_convert_ggsw_ciphertext_unchecked(
        ...
        let output_impl = ImplFourierBootstrapKey::allocate(
            Complex64::new(0., 0.),
            input.glwe_dimension().to_glwe_size(),
            input.polynomial_size(),
            input.decomposition_level_count(),
        ...
        let mut output_bsk = FourierLweBootstrapKey32(output_impl);
        ...
        output
            ...
            .as_mut_tensor()
            .as_mut_slice()
            .clone_from_slice(output_bsk.0.as_tensor().as_slice());
    }
}
...
impl GgswCiphertextDiscardingConversionEngine<GgswCiphertext64, GgswCiphertextComplex64>
    for CoreEngine
{
    /// # Example
    /// ```
    ...
    unsafe fn discard_convert_ggsw_ciphertext_unchecked(
        ...
        let mut output_bsk = FourierLweBootstrapKey64(output_impl);
