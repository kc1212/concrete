...
///
/// # Formal Definition
pub trait PackingKeyswitchKeyCreationEngine<InputSecretKey, OutputSecretKey, KeyswitchKey>:
    AbstractEngine
where
    ...
    >,
{
    ...
    fn create_packing_keyswitch_key(
        ...
        decomposition_base_log: DecompositionBaseLog,
        noise: Variance,
    ) -> Result<KeyswitchKey, PackingKeyswitchKeyCreationError<Self::EngineError>>;
